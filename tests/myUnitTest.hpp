...
# define TESTABLE_RUN(Testable)         \
    std::cout << #Testable << "\n";                                                   \
    for (std::map <const std::string, std::list< const class TestCase> >::iterator suite_it = g_test_cases[#Testable].begin(); suite_it != g_test_cases[#Testable].end(); suite_it++) \
    { \
...
# define TEST_SUITE_RUN(Testable, TestSuite)                                        \
    {                                                                                    \
        ...
        {                                                                                \
            for (std::list< const class TestCase>::iterator case_it = g_test_cases[#Testable][#TestSuite].begin(); \
